...
function HeroLanding() {
  ...
  return (
    <header className= " h-auto  md:py-[3vw]    ">
      <div className="relative min-h-[65vw]  md:min-h-[30vw]   h-auto  py-[2vw]   md:py-[11vw] lg:py-[unset]  lg:min-h-[25vw] lg:max-h-[600px]   border   ">
          ...
          {solutionsInfo.map((item, index) => {
            return (
              ...
              >
                ...
                <h4 className="text-[2.3em] leading-[1em]  w-[70%] py-1 font-montserrat font-normal text-lg md:text-[1.7em]">
                  {item.title}
                </h4>
